...
namespace kursach
{
    public class AddCourseRequestForm : Form
    {
        ...
        public AddCourseRequestForm(User user)
        {
            currentUser = user;
        ...
        {
            Text = "Добавить заявку на курс - ДПО Portal";
            Width = 500;
            Height = 450;
            ...
            titleLabel.Text = "Новая заявка на курс";
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            bool success = db.AddCourseRequest(
            ...
            {
                MessageBox.Show(
                    "Заявка на курс успешно создана!\n\n" +
